...
public class HttpUtil {
    ...
    public static String getRequest(String url) {
        ...
        HttpResponse response = null;
        get.setHeader("Host","ip.taobao.com");
        get.setHeader("User-Agent", "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/65.0.3325.162 Safari/537.36");
        try {
